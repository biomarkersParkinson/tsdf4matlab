function [mat_list_metadata, mat_list_data] = load_tsdf_metadata_from_path(mat_metadata_path)
    ...
    [py_succ, py_list_metadata, py_list_data] = pyrunfile("tsdf_python_interface\load_tsdf_metadata_from_path.py", "load_tsdf_metadata_from_path",["Success" "Return_list_metadata" "Return_list_data"], path_to_metadata=py_metadata_path);
