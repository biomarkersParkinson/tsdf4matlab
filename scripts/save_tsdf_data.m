function [mat_succ] = save_tsdf_data(mat_list_metadata, mat_list_data, mat_dir_path)
    ...
    [py_succ, py_list_metadata, py_list_data] = pyrunfile("tsdf_python_interface\load_legacy_tsdf_metadata_from_path.py",["Success" "Return_list_metadata" "Return_list_data"], py_list_metadata=py_list_metadata, py_list_data=py_list_data, py_dir_path=py_dir_path, py_metadata_file_name=py_metadata_file_name);
